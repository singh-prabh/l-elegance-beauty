...
<head>
    ...
    <title>L'Elegance Beauty-Admin Home</title>
...
<div class="container marketing">
    ...
    <div class="row">
        <div class="col-md-4 text-center col-sm-12">
            ...
            <p>Here you can keep your current products updated!</p>

        </div>
        <div class="col-md-4 text-center col-sm-12">
            <img class="img-circle" src="../Images/pic2.jpg">
            <h2> View Orders Online</h2>
            <p>Here you can view all users and the orders they made!</p>

        </div>
        <div class="col-md-4 text-center col-sm-12">
            <img class="img-circle" src="../Images/pic3.jpg">
            <h2>Update Treatments</h2>
            <p>Here you can keep your current treatments updated!</p>
